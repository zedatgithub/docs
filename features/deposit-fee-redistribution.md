...
* 20% of collected BUSD and DEFI  used to [add liquidity](automatic-liquidity.md) DEFI-BUSD and sent to Locker
* 20% of collected USDT and DEFI  used to [add liquidity](automatic-liquidity.md) DEFI-USDT and sent to Locker
* 20% of collected USDC and DEFI  used to [add liquidity](automatic-liquidity.md) DEFI-USDC and sent to Locker
* 20% of collected DAI and DEFI  used to [add liquidity](automatic-liquidity.md) DEFI-DAI and sent to locker
