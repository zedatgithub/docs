...
{% hint style="info" %}
When harvesting from **farms**, the **14%** tax is applied \(as basically it is a transaction where TKENB is going from one address to another address\). In [**vaults**](vaults.md), for the auto-compound feature, the **14%** transfer tax is removed, but the deposit fee is applied as mentioned in the table below.
{% endhint %}
