...
* Lottery Ticket price will always be **2 USD** worth of NATIVE Token, \(the necessary amount will be adjusted after every draw in concordance with NATIVE Token price\)
