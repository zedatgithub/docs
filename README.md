---
description: >-
  PANCAKE - Stable Yield Farming with Boosted Farms On Binance Smart Chain and
  AMM
---
...
### About Pancake <a id="about-pantherswap"></a>

Pancake is the first **stable-pairs-only** yield farm and AMM decentralized exchange running on Binance Smart Chain, featuring the first ever **Boosted Farms** __innovation, together with lots of other unique and creative features.
...
* [Farming Pools](features/token-pools.md) where you deposit PANCAKE and earn **other tokens**
